...
class Book(BaseObject):
    ...
    def names_epilogue(self):
        ...
        if blah:
            ...
            print("_all_sheets_map", ascii(self._all_sheets_map), file=f)
            print("_extnsht_name_from_num", ascii(self._extnsht_name_from_num), file=f)
            print("_sheet_num_from_name", ascii(self._sheet_num_from_name), file=f)
        ...
        while 1:
            ...
            if rc == XL_SST:
                ...
                if self.biff_version == 45:
                    ...
                    #     print ascii(self.mem[pos:pos+40])
                return
            else:
                # if DEBUG:
